    ...
    <div class="section-inner">
        <div class="container">
            <div class="intro-text">
                <div class="intro-lead-in wow zoomIn" data-wow-delay="0.3s"><?= __('اربح المال من مشاركة الروابط') ?></div>
                <div class="intro-heading wow pulse" data-wow-delay="2.0s"><?= __('طريقك إلى الثراء') ?></div>
